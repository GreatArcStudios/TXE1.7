	...
	TXEAREA.setText(DefualtText);
        ...
        srenSht.addActionListener(new ActionListener(){
        	public void actionPerformed(ActionEvent e){
        		TXESHOT txesh = new TXESHOT();
                        txesh.setVisible(true);
        ...
        coL.addActionListener(new ActionListener(){
        	public void actionPerformed(ActionEvent e){
        		color= JColorChooser.showDialog(null, "Pick Text Color", color);
        ...
        //add stuff to format
        format.add(plain); format.add(bold);format.add(italics);format.add(bI);format.addSeparator();format.add(Fr);format.addSeparator();format.add(coL);format.add(bLa);format.add(rD);format.add(gR);format.add(bL);format.addSeparator();format.add(rsA);format.add(lsA);
       ...
       //file menu items
        ...
        //tools menu items
        TXESettings.add(settingsFrame);TXESettings.addSeparator();TXESettings.add(srenSht);TXESettings.addSeparator();TXESettings.add(addwebsite);TXESettings.add(addname);TXESettings.add(addcompany);TXESettings.addSeparator(); TXESettings.add(caL);TXESettings.add(enC);
        ...
        this.setTitle("TXE 1.7 Beta - " + currentFile);
...
Action New = new AbstractAction("New", new ImageIcon(getClass().getResource("images/new.gif"))) {
	...
	public void actionPerformed(ActionEvent e) {
            ...
            setTitle("TXE 1.7 Beta - "+currentFile);
